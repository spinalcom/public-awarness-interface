    ...
    export default {
        ...
        methods: {
                ...
                getGraph()
                    ...
                    .then((svf) => {
                        ...
                        */
                        ...
                        if (originUrl.indexOf("srd") !== -1)
                            originUrl.replace("svf", "puppeteer");
            ...
            onGeometryLoaded(event) {
                ...
                this.loaded = true;
                //if  (typeof this.model.getPropertyDb() === "undefined")
                const originUrl = window.location.origin;
                ...
                if (typeof this.model.getPropertyDb() === "undefined") {
                    ...
                    if (originUrl.indexOf("srd") !== -1)
                        originUrl.replace("srd", "puppeteer");
                    axios.get(originUrl + `/${this.urn}/${this.attrName}`)
                        .then((r) => {
                            return this.finalizeInitialization({dbIds: r.data})
                        }).catch(console.error)
                } else
                    return getValues(this.model, this.attrName)
                        .then(this.finalizeInitialization.bind(this));
            },
            finalizeInitialization(res) {
